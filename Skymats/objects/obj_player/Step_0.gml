...
if !instance_exists(obj_multiplayer_world_loader) && !(on_ground != noone && on_ground.object_index == obj_platform) && collision_line(bbox_right+1, bbox_top, bbox_right+1, bbox_bottom, obj_platform, false, true) == noone
	x += SCROLL_SPEED;
